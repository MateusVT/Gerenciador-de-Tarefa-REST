    ...
    _createClass(App, [{
        ...
        value: function userEvents() {
            ...
            this.user.on("error", function () {
                return alert("Erro ao carregar o usuario");
            });
...
exports.render = function () {
    return "\n        <form>\n            <div class=\"list\">\n                <label class=\"item item-input item-stacked-label\">\n                    <span class=\"input-label\">Nova Tarefa</span>\n                    <input type=\"text\" data-task>\n                </label>\n            </div>\n            <div class=\"padding\">\n                <button class=\"button button-dark button-block\">\n                    <i class=\"ion-compose\"></i> Adicionar\n                </button>\n            </div>\n        </form>\n    ";
};
